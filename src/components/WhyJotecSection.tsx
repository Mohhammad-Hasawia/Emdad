    ...
    <section className="py-20 bg-emdad-navy">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <h2
            className={`text-lg sm:text-xl md:text-2xl font-bold text-emdad-gold mb-12 md:mb-16 text-center animate-fade-in-up leading-tight ${
              ...
              >
                <div className="flex items-start space-x-4 rtl:space-x-reverse">
                  ...
                  <div className="flex-1">
                    <h3
                      className={`text-lg sm:text-xl md:text-2xl font-semibold text-white mb-3 ${
