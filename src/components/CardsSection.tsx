...
import { Award, CircleHelp as HelpCircle, Mail } from 'lucide-react';
            ...
            return (
              ...
              >
                ...
                <CardContent className="p-4 md:p-6">
                  ...
                  <Button
                    className="bg-emdad-gold hover:bg-yellow-500 text-white w-full transition-all duration-200 text-base"
