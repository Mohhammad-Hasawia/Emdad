...
import { Shield, Users, CircleCheck as CheckCircle, Award, Wrench, FileText } from 'lucide-react';
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {safetyMeasures.map((measure, i) => (
                <Card 
                  key={i} 
                  className="p-6 hover:shadow-lg transition-shadow duration-300 animate-fade-in-up" 
